	...
	public static void main(String[] args) throws UserNotFoundException,MechanicNotFoundException {
			...
			if (admin) {
				...
				do {
					...
					case 3:
						...
						break;
					case 4:
						System.out.println("AllowOrBlockMechanic");
						break;
					}
		...
		case 2:
			...
			case 1:
				...
				try {
					Mechanic mcnentity = new Mechanic(mId, mname, mpass, memail, phone, servicetype,
							location);
			...
			case 2:
				...
				if(mechanic)
				{
					do {
						...
						{
						case 1:
							List<Service> list4=mcn.viewRequest();
							System.out.println("-------------Displaying Request Details------------");
							System.out.println();
							System.out.println("UserId" + "\t" + "Service Type" + "\t" + "Location");
							for (Service s : list4) {
								System.out.println(s.getUserId() + "\t\t" + s.getServiceType() + "\t\t" +s.getLocation());
							}

							break;
						case 2:
							List<Feedback> list5=mcn.viewFeedback();
							System.out.println("-------------Displaying Feedback Details------------");
							System.out.println();
		...
		case 3:
			...
			case 2:
				...
				case 4:
				{
					...
					System.out.println("Enter user id:");
					int userId3=scn.nextInt();
					System.out.println("Enter mechanic id:");
					mechanicId=scn.nextInt();
					System.out.println("Enter ratings:");
					float ratings=scn.nextFloat();
					Feedback feed=new Feedback(fid,userId3,mechanicId,feedback,ratings);
					try
					{
						...
						{
							throw new InvalidFeedbackException("Feedback not added");
						}
					}
